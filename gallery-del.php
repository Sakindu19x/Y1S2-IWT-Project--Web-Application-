    ...
    <div class="text-content">
        <div class="col-1">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                <input type="text" name="caption" placeholder="Enter Image Caption" value="<?=$caption?>" readonly>
                <input type="hidden" name="img_name" value="<?=$img_name?>">
                <input type="hidden" name="gal_id" value="<?=$gal_id?>">

                <button type="submit" class="button button1" name="submit" value="submit">Delete</button>
