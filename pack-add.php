...
if (isset($_POST['submit'])){
    ...
    $sql_s = "INSERT INTO pack (
                    pack_name,
                    pack_sub,
                    pack_desc,
                    pack_amount
                ) VALUES (     
                   '".mysql_escape_cust($pack_name)."',
                   '".mysql_escape_cust($pack_sub)."',
                   '".mysql_escape_cust($pack_desc)."',
                   '".mysql_escape_cust($pack_amount)."'
                )";
...
<div class="container">
    ...
    <div class="text-content">
        <div class="col-2">
            <h2 class="hd-1">Package - Add </h2>

            <a href="pack-img.php?pack_type=<?=$pack_type?>" class="button button3"> Package Image </a>

            <form class="needs-validation" novalidate method="post" action="pack-add.php" name="registration_form">
        ...
        <div class="col-2">
            <img src="./packimg/<?=$img_name?>" alt="<?=$pack_name?>" style="width: 50%;" >
        </div>
